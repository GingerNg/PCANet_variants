function [f BlkIdx] = feaPCANet_FeaExt(InImg,V,PCANet)
% =======INPUT=============
...
for stage = 1:PCANet.NumStages
     [OutImg ImgIdx] = QPCA_output(OutImg, ImgIdx, ...
...
[f BlkIdx] = HistreplaceSc_1(PCANet,ImgIdx,OutImg,Img_one);
