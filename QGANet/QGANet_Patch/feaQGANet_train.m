function [f V BlkIdx] = feaQGANet_train(InImg,PCANet,IdtExt)  % IdtExt = 1;
% =======INPUT=============
...
for stage = 1:PCANet.NumStages
    ...
    V{stage} = QGA_FilterBank(OutImg, PCANet.PatchSize, PCANet.NumFilters(stage)); % compute PCA filter banks
